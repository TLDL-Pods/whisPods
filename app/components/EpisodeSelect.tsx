      ...
      <div className="flex flex-col flex-grow w-full min-h-full text-center transition-all duration-500 border-t bg-stone-950 border-violet-400 border-opacity-40 hover:bg-stone-800">
        ...
        <div className="flex items-center mx-auto w-full lg:w-1/2 lg:p-0 p-2">
          <div className="flex flex-col mr-2">
            <span className=" font-bold text-violet-300 lg:text-2xl lg:border-b border-violet-300 border-opacity-40 lg:pb-1 lg:mb-2">
          ...
          <div className="w-full">
            <div className="lg:text-2xl lg:text-left text-violet-300">
              {episode.episode_title
                ? episode.episode_title.toUpperCase()
                : null}
            </div>
            <div className="mt-2 text-violet-100 hidden lg:block">
