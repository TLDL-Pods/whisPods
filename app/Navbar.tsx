    ...
    <div className="max-w-screen">
      ...
      >
        ...
        <div
          ...
          className={`${state.isMenuModalOpen ? 'left-0' : '-left-[100%]'} absolute top-24 mx-auto flex w-full flex-col justify-center gap-2 bg-black bg-opacity-[96%] px-8 pb-8 duration-300 lg:w-64 lg:px-10 lg:pt-4`}
        >
          <div
