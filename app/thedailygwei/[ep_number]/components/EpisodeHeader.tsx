    ...
    <div className="w-full max-w-screen px-4">
      <div>
        <Link href={`/thedailygwei`}>
          <div className="text-xl pt-8 md:pt-0 text-center md:text-xl lg:text-2xl text-secondary hover:opacity-90 w-fit mx-auto duration-100">
            The Daily Gwei Refuel
          </div>
        </Link>
        <div className="text-center md:text-xl lg:text-xl text-primary">
      ...
      <div className="lg:max-w-[1200px] lg:mx-auto lg:mt-0 mt-4">
